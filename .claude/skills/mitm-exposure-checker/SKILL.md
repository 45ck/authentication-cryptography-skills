---
name: "mitm-exposure-checker"
pack: "authentication-cryptography-pack"
purpose: "Check where man-in-the-middle exposure exists across transport, key exchange, validation, downgrade, proxy, and trust-boundary paths."
...
handoffs: ["remote-auth-protocol-reviewer", "certificate-chain-reviewer", "trust-store-reviewer"]
---
# mitm-exposure-checker

## Purpose
Check where man-in-the-middle exposure exists across transport, key exchange, validation, downgrade, proxy, and trust-boundary paths.
