---
name: "challenge-response-reviewer"
pack: "authentication-cryptography-pack"
purpose: "Review challenge-response mechanisms for nonce freshness, replay resistance, verifier trust, secret exposure, and implementation pitfalls."
...
handoffs: ["remote-auth-protocol-reviewer", "mitm-exposure-checker", "certificate-revocation-reviewer"]
---
# challenge-response-reviewer

## Purpose
Review challenge-response mechanisms for nonce freshness, replay resistance, verifier trust, secret exposure, and implementation pitfalls.
