---
name: "certificate-revocation-reviewer"
pack: "authentication-cryptography-pack"
purpose: "Review revocation design and handling assumptions including CRLs, OCSP, expiry, grace periods, cache behavior, and failure handling."
...
handoffs: ["certificate-chain-reviewer", "trust-store-reviewer", "mitm-exposure-checker"]
---
# certificate-revocation-reviewer

## Purpose
Review revocation design and handling assumptions including CRLs, OCSP, expiry, grace periods, cache behavior, and failure handling.
