---
name: "trust-store-reviewer"
pack: "authentication-cryptography-pack"
purpose: "Review trust-store contents, source of trust anchors, update paths, custom certificates, pinning, and local override risks."
...
handoffs: ["certificate-chain-reviewer", "certificate-revocation-reviewer", "mitm-exposure-checker"]
---
# trust-store-reviewer

## Purpose
Review trust-store contents, source of trust anchors, update paths, custom certificates, pinning, and local override risks.
