---
name: "biometric-auth-risk-reviewer"
pack: "authentication-cryptography-pack"
purpose: "Review whether biometric authentication is appropriate, what risks it introduces, and which fallback and recovery paths are required."
...
handoffs: ["identification-vs-authentication-reviewer", "challenge-response-reviewer", "password-policy-reviewer"]
---
# biometric-auth-risk-reviewer

## Purpose
Review whether biometric authentication is appropriate, what risks it introduces, and which fallback and recovery paths are required.
