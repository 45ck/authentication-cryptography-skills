---
name: "password-policy-reviewer"
pack: "authentication-cryptography-pack"
purpose: "Review password rules, storage assumptions, reset flows, rate limits, and recovery mechanisms for security and usability tradeoffs."
...
handoffs: ["identification-vs-authentication-reviewer", "mitm-exposure-checker", "certificate-chain-reviewer"]
---
# password-policy-reviewer

## Purpose
Review password rules, storage assumptions, reset flows, rate limits, and recovery mechanisms for security and usability tradeoffs.
